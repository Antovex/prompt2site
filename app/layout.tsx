...
export const metadata: Metadata = {
  ...
  description: "Generate, edit and explore website designs with AI. Export code instantly with our powerful AI website generator.",
  keywords: ["AI website generator", "web design", "code generation", "prompt to website"],
